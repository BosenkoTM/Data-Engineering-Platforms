...
## Data Prep на примере Tableau Prep и Alteryx
...
## Требования к ETL разработчику и отличия от Data Engineer
...
### [Лабораторная работа 2.1 Создание полного dbt-проекта для преобразования сырых данных в аналитические витрины](https://github.com/BosenkoTM/Data-Engineering-Platforms/tree/master/modules/Module04/superstore_dwh_advanced) 
