...
6. Создать дашборд и создать аккаунт на [Tableau Public](https://public.tableau.com/s/), куда сможете загрузить свои дашборды. Постарайтесь использовать как можно больше Tableau функциональности, но не забывайте о красоте и простоте.
