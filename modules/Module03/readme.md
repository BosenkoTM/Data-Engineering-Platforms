...
Размещены на портале [Лабораторная работа 3.1 Создание аналитического дашборда для бизнес-анализаЗадание](http://95.131.149.21/moodle/mod/assign/view.php?id=677)
