...
1 Есть ли у вас доступ к BI решению? Если есть, то попробуйте отыскать все элементы, про которые я рассказывал. Если нет, то попробуйте найти любой продукт BI, установить его, и посмотреть, что внутри.

2 Визуализация данных из CSV-файла. 
...
1 Посмотрите на ваши дашборды на работе или в модуле 1 и 2. Что вы могли бы улучшить?
...
1. Установить Tableau Desktop [инструкция](https://github.com/BosenkoTM/Data-Engineering-Platforms/blob/master/how-to/how-to-tabelau-desktop.md#how-to-%D0%BA%D0%B0%D0%BA-%D1%83%D1%81%D1%82%D0%B0%D0%BD%D0%BE%D0%B2%D0%B8%D1%82%D1%8C-tableau-desktop).
2. Подключитесь к БД Postgres и нарисуйте дашборд, который делали в лабораторной работе 1 или 2. Понять, как работает:
...
3. Создать дашборд и создать аккаунт на [Tableau Public](https://public.tableau.com/s/), куда сможете его загрузить. Постарайтесь использовать как можно больше Tableau функциональности, но не забывайте о красоте и простоте.
