...
- Существующая база данных `superstore` на хосте
...
**Создайте необходимые схемы в существующей базе данных через pgAdmin:**
1. Откройте pgAdmin в браузере (http://localhost:80)
2. Подключитесь к PostgreSQL серверу используя существующие учетные данные:
   - **Host**: localhost
   - **Port**: 5432
   - **Username**: postgres
   - **Password**: post1616!
